...
class CustomerGlobal(models.Model):
    ...
    gender = models.CharField(choices=GENDER_TYPE,max_length=255, blank=False, null=False)
...
class CustomerUser(models.Model):
    ...
    pincode = models.ForeignKey(PincodeMaster,blank=True, null=True, on_delete=models.CASCADE)
    mobile_number = models.CharField(max_length=10, blank=True, null=True)
    alternate_mobile_number = models.CharField(max_length=10, blank=True, null=True)
    email = models.CharField(max_length=255, blank=False, null=False)
...
class CustomerDistributorMapping(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Customer Mapping with Distributor"       
...
class CustomerApproval(models.Model):
    ...
    customer = models.ForeignKey(CustomerUser, blank=True, null=True,on_delete=models.CASCADE)
    customer_status = models.CharField(choices=CUSTOMER_STATUS,max_length=255, blank=False, null=False)
    is_deleted = models.BooleanField(blank=False, null=False, default=False)
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class CustomerBankDetail(models.Model):
    ...
    payment_mode        = models.CharField(choices=PAYMENT_MODE,max_length=255, blank=False, null=False)
